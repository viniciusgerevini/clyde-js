...
describe("parse: logic", () => {
  ...
  describe("conditions", () => {
    ...
    it("less or equal and greater or equal", () => {
      const result = parse(
        `{ first_time <= second_time and third_time >= fourth_time } second comparison`,
      );
      ...
      const expected = createDocPayload([
        {
          ...
          conditions: {
            type: "expression",
            name: "not_equal",
            elements: [{ type: "variable", name: "first_time" }, { type: "null" }],
          },
          ...
          content: [
            {
              ...
              content: {
                ...
                content: {
                  type: "content",
                  content: [{ type: "line", value: "option 1" }],
                },
              },
            },
            {
              ...
              content: {
                ...
                content: {
                  type: "content",
                  content: [{ type: "line", value: "option 2" }],
                },
              },
            },
            {
              ...
              content: {
                ...
                content: {
                  type: "content",
                  content: [{ type: "line", value: "option 3" }],
                },
              },
            },
          ],
...
`);
            ...
            },
            {
              ...
              action: {
                ...
                assignments: [
                  {
                    type: "assignment",
                    variable: { type: "variable", name: "c" },
                    operation: "assign",
                    value: { type: "literal", name: "number", value: 4 },
                  },
                ],
              },
              content: {
  ...
  describe("events", () => {
    ...
    it("trigger event with parameters", () => {
      const result = parse(
        `{ trigger some_event(this_is_a_var, this_is_a_var + 1, 123, "text", false) } trigger`,
      );
      const expected = createDocPayload([
        {
          type: "action_content",
          ...
          branches: [
            {
              ...
              content: {
                type: "content",
                content: [{ type: "line", value: "This is a line" }],
              },
            },
            {
              ...
              content: {
                type: "content",
                content: [{ type: "line", value: "This is another line" }],
              },
            },
          ],
          default_branch: {
            type: "content",
            content: [{ type: "line", value: "This is the default line" }],
          },
        },
      ]);
      expect(result).toEqual(expected);
