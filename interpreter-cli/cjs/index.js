...
const yargs = (m => m.__esModule ? /* istanbul ignore next */ m.default : /* istanbul ignore next */ m)(require('yargs'));
const { Parser } = require('clyde-parser');
const { Interpreter } = require('clyde-interpreter');

async function execute(args, exitCallback = process.exit, commandName) {
...
const buildArgsParser = (yargs, commandName = '$0') => {
  const argv = yargs
...
exports.buildArgsParser = buildArgsParser;
