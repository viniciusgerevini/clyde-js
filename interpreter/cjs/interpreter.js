'use strict';
const { LogicInterpreter } = require('./logic_interpreter.js');
const { Memory } = require('./memory.js');
const { Events, events } = require('./events.js');

(m => {
  exports.events = m.events;
})(require('./events.js'));

function Interpreter(doc, data, dictionary = {}) {
